...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-96 md:h-160 bg-transparent relative flex items-center w-full justify-center overflow-hidden",
        className
      )}
    >
      {beams.map((beam) => (
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 inset-x-0 w-full pointer-events-none bg-transparent"
        style={{
          boxShadow:
            "0 0 20px rgba(0, 0, 0, 0.08), 0 1px 1px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(255, 255, 255, 0.02), 0 0 4px rgba(0, 0, 0, 0.06), 0 16px 68px rgba(0, 0, 0, 0.05), 0 1px 0 rgba(255, 255, 255, 0.03) inset",
        }}
      />
    </div>
  );
