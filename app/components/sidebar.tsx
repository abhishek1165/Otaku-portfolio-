...
const Sidebar = (): React.ReactElement => {
  ...
  const socials = [
    {
      label: "X (Twitter)",
      href: "https://x.com/Kachhap3079",
      svgPath:
        "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z",
    },
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/abhishek-kachhap-",
      svgPath:
    ...
    {
      label: "Github",
      href: "https://github.com/abhishek1165",
      svgPath:
    ...
    {
      label: "Instagram",
      href: "https://www.instagram.com/abhishek.kachhap.568/",
      svgPath:
    ...
    <>
      ...
      <div
        className={`${s.mobileOverlay}
         ${isOpen ? s.mobileOverlayVisible : s.mobileOverlayHidden} `}
      >
        <div
          className={`${s.mobileOverlayBg}
                ${
                  isOpen ? s.mobileOverlayBgVisible : s.mobileOverlayBgHidden
                } `}
          onClick={() => setIsOpen(false)}
        />

        <div
          className={`${s.mobileSidebar} ${
            isOpen ? s.mobileSidebarVisible : s.mobileSidebarHidden
          }`}
        >
          ...
          <div className={s.mobileFooter}>
            <div className={s.mobileFooterLabel}>Reach Me</div>

            <div className={s.mobileFooterText}>
              <div>Made By Abhishek Kachhap | @2026</div>
            </div>
          </div>
        </div>
      </div>
                ...
                {navItems.map(({ href, Icon, label }) => (
                  <Link
                    ...
                    className={`${s.bottomNavLink} ${
                      pathname === href
                        ? s.bottomNavLinkActive
                        : s.bottomNavLinkInactive
                    }`}
                    aria-label={label}
                  >
